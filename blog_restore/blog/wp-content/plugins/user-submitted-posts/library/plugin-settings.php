				...
				<div class="meta-box-sortables ui-sortable">
						...
						<div class="toggle<?php if (!isset($_GET['settings-updated'])) echo ' default-hidden'; ?>">
									...
									<tr>
										...
										<td>
											<span class="mm-item-caption">
												...
												<strong><a target="_blank" href="https://plugin-planet.com/usp-pro/" title="<?php esc_attr__('Go Pro!', 'usp'); ?>"><?php esc_html_e('USP Pro', 'usp'); ?>&nbsp;&raquo;</a></strong>
											</span>
										</td>
									</tr>
								</table>
							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									...
									<tr>
										<th scope="row"><label class="description" for="usp_options[auto_display_custom]"><?php esc_html_e('Custom Field Auto-Display', 'usp'); ?></label></th>
										<td>
					...
					<div id="mm-panel-secondary" class="postbox">
						...
						<div class="toggle default-hidden">
							...
							<p><?php esc_html_e('Use the shortcode to display the form on any WP Post or Page:', 'usp'); ?></p>
							<p><code class="mm-code">[usp-login-form]</code></p>
							<p><?php esc_html_e('Or, use the template tag to display the form anywhere in your theme template:', 'usp'); ?></p>
							<p><code class="mm-code">&lt;?php if (function_exists('usp_login_form')) usp_login_form(); ?&gt;</code></p>
							<br>
							...
							<p><code class="mm-code">[usp_display_posts]</code></p>
							<p><?php esc_html_e('Or, use the template tag to display a list of submitted posts anywhere in your theme template:', 'usp'); ?></p>
							<p><code class="mm-code">&lt;?php if (function_exists('usp_display_posts')) usp_display_posts(); ?&gt;</code></p>
...
[usp_display_posts userid="all" numposts="5"] : limit to 5 posts from all users</pre>
							...
							<p><code class="mm-code">[usp_access cap="read" deny="Message for users without read capability"][/usp_access]</code></p>
							<p><?php esc_html_e('Display content to logged-in users:', 'usp'); ?></p>
							<p><code class="mm-code">[usp_member deny="Message for users who are not logged in"][/usp_member]</code></p>
							<p><?php esc_html_e('Display content to visitors only:', 'usp'); ?></p>
							<p><code class="mm-code">[usp_visitor deny="Message for users who are logged in"][/usp_visitor]</code></p>
