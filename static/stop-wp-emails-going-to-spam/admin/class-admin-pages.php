...
*/
	...
	public function footer_scripts() {
		$page_hook_id = $this->settings_page_id;
		$confmsg=__('Are you sure want to do this?','stop-wp-emails-going-to-spam');
		?>
		...
		<div id="submitpost" class="submitbox">
			...
			<div id="major-publishing-actions">
				...
				<div id="delete-action">
					<input type="submit" name="<?php echo "{$this->option_group}-reset"; ?>" id="<?php echo "{$this->option_group}-reset"; ?>"
					       class="button"
